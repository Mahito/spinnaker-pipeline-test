{
  pipeline():: {
    ...
    withAppConfig(appConfig):: self + { appConfig: appConfig },
  ...
  stages:: {
    ...
    deployManifest(name):: stage(name, 'deployManifest') {
      ...
      withSkipExpressionEvaluation(skipExpressionEvaluation):: self + { skipExpressionEvaluation: skipExpressionEvaluation },
  ...
  kubernetes:: {
    ...
    trafficManagement():: {
      ...
      isEnabled(enabled):: self + { enabled: enabled },
